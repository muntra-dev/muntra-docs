...
function BookingWidget() {
  ...
  return (
    <div className="auto-margin page-body">
      <div className="flex-column">
        ...
        <ol>
          <li className="has-line-data" data-line-start={8} data-line-end={9}>
            ...
            You can find examples their corresponding div:s down below
          </li>
      ...
      <div className="flex-column">
        <h3 style={{ marginTop: "50px" }}>Without caregivers at clinic</h3>
        <pre>
          <code
            className="has-line-data"
            data-line-start="32"
      ...
      <ul>
        <li className="has-line-data" data-line-start="1" data-line-end="3">
          ...
          <p>
            A missing whitelisting is indicated in the browser's inspector. Eg.
            in the Networks tab in Google Chrome.
          </p>

          <p>
            The whitelisting and any troubleshooting are usually done by Muntra
            personnel.
          </p>
        </li>
      </ul>
      ...
      <p className="has-line-data" data-line-start="5" data-line-end="6">
        First, place the &lt;div&gt; tag in the site markup, with the following
        attributes:
      </p>
      ...
      <ul>
        <li className="has-line-data" data-line-start="15" data-line-end="16">
          ...
          only a specific caregiver for this clinic, then enter the caregiver id
          here),
        </li>
        ...
        <li className="has-line-data" data-line-start="20" data-line-end="21">
          <code>muntra_without_modal</code>: “true” (Use it to display a widget
          without a button and outside the modal window),
        </li>
      ...
      <pre>
        <code className="has-line-data" data-line-start="26" data-line-end="28">
      ...
      <pre>
        <code className="has-line-data" data-line-start="32" data-line-end="34">
          &lt;script type = &quot;text/javascript&quot; src =
          &quot;https://muntra-dev.github.io/index.js&quot;&gt; &lt;/script&gt;
        </code>
      </pre>
      ...
      <pre>
        <code className="has-line-data" data-line-start="40" data-line-end="52">
          &lt;body&gt; &lt;div class=&quot;auto-margin&quot;&gt; &lt;div
          class=&quot;flex-column right-align&quot;&gt; &lt;h3&gt;Alla
          behandlare&lt;/h3&gt; &lt;div class=&quot;muntra-widget primary&quot;
          key='1' muntra_clinic_id=&quot;YOUR_CLINIC_ID&quot;
          muntra_referral_source=&quot;YourClinicDomain.com&quot;&gt;
          &lt;/div&gt; &lt;/div&gt; &lt;/div&gt; &lt;script
      ...
      <pre>
        <code className="has-line-data" data-line-start="58" data-line-end="66">
      ...
      <pre>
        <code className="has-line-data" data-line-start="70" data-line-end="76">
      ...
      <pre>
        <code className="has-line-data" data-line-start="82" data-line-end="90">
          .muntra-widget {"{"}
      ...
      <pre>
        ...
        >
          ...
          width{":"} 100%; max-width: 720px; height{":"} 500px; border{":"} 1px
          solid lightgrey; border-radius{":"} 15px;
          {"}"}
        </code>
      </pre>
      ...
      <ol>
        <li>
          When a booking is created, the patient should receive an email with a
        ...
        <li>
          This link should lead to a page with the booking widget. When the
          "m_id" query param is used, the widget shows booking details, and
          confirmation and rescheduling buttons. Please note that there are
          settings in the booking that allows or prevents rescheduling.
        </li>
        <li>The confirmation button confirms the booking</li>
        <li>
          The rescheduling button displays a page for selecting and confirming
          an available time
        </li>
      </ol>
      ...
      <ol>
        <li>
          Have you entered the correct <code>muntra_clinic_id</code> in place of{" "}
          <b>YOUR_CLINIC_ID</b> from the example above?
        </li>
        <li>
        ...
        <li>
          ...
          different domain name than the live website? Then it wont work unless
          that domain is also whitelisted
        </li>
      </ol>
      ...
      <ol>
        ...
        <li>
          Check if the widget is enclosed by tags that looks something like this{" "}
          <code>{`<iframe><div class="muntra-widget"...</iframe>`}</code> ("..."
